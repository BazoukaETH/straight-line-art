...
import { TrendingUp, AlertTriangle, Clock, Rocket, Briefcase, Users, DollarSign, Target, ArrowUpRight, ArrowDownRight, Activity, Wallet, Flame, Repeat, CheckCircle2 } from "lucide-react";
...
function FounderDashboard() {
  ...
  return (
    <AppShell breadcrumb={<span className="font-medium text-foreground">Founder Dashboard</span>}>
      <div className="px-6 py-6 space-y-5">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-2">
          {(() => {
            ...
            // NOTE: nascent's `kpi.link` jumped to "/finance" when cash was 0.
            // We don't have a /founder/finance route yet (will be added when Finance page is ported).
            // For now KPI cards are non-clickable. Re-wire when Finance ports in.
            const kpis = [
