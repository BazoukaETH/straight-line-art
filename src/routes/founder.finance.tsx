...
function OverviewPanel({ subsCancelled, subsTotal, subsProjectedSavings }: { subsCancelled: number; subsTotal: number; subsProjectedSavings: number }) {
      ...
      <Card className="border-border bg-gradient-to-r from-[color:var(--accent)]/8 to-transparent p-5">
        <div className="flex flex-wrap items-center gap-5">
          <div className="flex-1 min-w-[220px]">
            ...
            <div className="mt-0.5 text-2xl font-semibold">{subsCancelled} / {subsTotal}</div>
          </div>
          <div className="flex-1 min-w-[220px]">
            <div className="text-xs text-muted-foreground">Projected monthly savings at full migration</div>
            <div className="mt-0.5 text-2xl font-semibold text-[color:var(--success)]">{egp(subsProjectedSavings)}</div>
          </div>
          <Link to="/founder/finance">
